package com.vp.VentaProducto.configsegurity;

import com.vp.VentaProducto.FiltoSeguridad.JwtAuthFilter;
...
public class ConfiguracionDeSeguridad {
    ...
    public ConfiguracionDeSeguridad(JwtAuthFilter authFilter) {
    ...
    public UserDetailsService userDetailsService(UsuarioRepository repository, PasswordEncoder passwordEncoder) {
        return new UsuarioInfoServicio(repository, passwordEncoder);
    }
    @Bean
